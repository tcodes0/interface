...
#========== Late sourcing
source $HOME/Desktop/interface/.aliases.bash
source $HOME/Desktop/interface/.functions.bash
source $HOME/GoogleDrive/Mackup/.private.bash
if [ -f $HOME/Desktop/interface/.prompt.zsh ]; then
  source $HOME/Desktop/interface/.prompt.zsh
else
  export PS1=$'\n%~\n%# '
fi
