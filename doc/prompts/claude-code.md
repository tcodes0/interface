...
Do not: add "generated by claude code" in PR descriptions, after opening a PR, check that description and remove this text if present, even if you didn't add it.
