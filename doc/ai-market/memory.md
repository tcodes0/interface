...
- **Micron** — SEC EDGAR XBRL company-concept API (CIK 0000723125), same method as capex.md:
  ...
  28/29, offsetting its fiscal quarters about one quarter *behind* calendar quarters — same
...
Moderation in the broader (+13-18%) forecast is attributed specifically to *consumer*
